...
const About = () => {
  ...
  return (
    <section id="about" className="md:pt-20 relative" ref={aboutRef}>
      ...
      ></div>
      <div className="container opcaity-90 hidden md:block max-w-350 mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="max-w-150">
            ...
            <p className="text-base md:text-lg text-slate-50 font-light leading-relaxed mb-4">
